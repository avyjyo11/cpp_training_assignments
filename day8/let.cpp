            ...
            std::visit([&](auto&& rval){
                std::visit([&](auto&& lval) {
                    if(typeid(rval)==typeid(int) && typeid(lval)==typeid(int)){
                      res.m_var = std::get<int>(std::get<VariantType>(m_var))+std::get<int>(std::get<VariantType>(other.m_var));
                    }else if(typeid(rval)==typeid(int) && typeid(lval)==typeid(double)){
                      res.m_var = (double)std::get<int>(std::get<VariantType>(other.m_var))+std::get<double>(std::get<VariantType>(m_var));
                    }else if(typeid(rval)==typeid(double) && typeid(lval)==typeid(int)){
                      res.m_var = std::get<double>(std::get<VariantType>(other.m_var))+(double)std::get<int>(std::get<VariantType>(m_var));
                    }else if(typeid(rval)==typeid(std::string) && typeid(lval)==typeid(std::string)){
                      res.m_var = std::get<std::string>(std::get<VariantType>(m_var))+std::get<std::string>(std::get<VariantType>(other.m_var));
                    }else if(typeid(rval)==typeid(double) && typeid(lval)==typeid(double)){
                      res.m_var = std::get<double>(std::get<VariantType>(other.m_var))+std::get<double>(std::get<VariantType>(m_var));
                    }
